...
- Straightens the crop, averages bands of pixels into clean 1D profiles, reads each profile with ZBar and ZXing and accepts a value only when at least `minVotes` profiles agree (default 3). The vote count is returned as the result quality
